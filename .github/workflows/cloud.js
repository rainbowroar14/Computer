...
(function () {
  ...
  async function loadProfile(username, password) {
    ...
    if (record) {
      if (record.passwordHash && record.passwordHash !== passwordHash) {
      ...
      return { profileId, username: record.username || displayName, isNew: false };
    }
  ...
  function setSession(profileId, username) {
